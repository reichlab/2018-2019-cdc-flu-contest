...
for(prediction_target in all_prediction_targets) {
  output_path <- "/home/er71a/2018-2019-cdc-flu-contest/inst/estimation/region-stacking/cluster-output"
  ...
  cat(paste0("R CMD BATCH --vanilla \'--args ",
    prediction_target, " ",
    cores_req,
    "\'  /home/er71a/2018-2019-cdc-flu-contest/inst/estimation/region-stacking/stacking_estimation.R ",
