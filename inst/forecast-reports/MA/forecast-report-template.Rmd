...
geom_line(data=data_ma[data_ma$season == "2017/2018",],aes(x=season_week,y=unweighted_ili),alpha=.1)+
  ...
  scale_x_continuous(labels= paste0("2018/2019-",unique(data_ma[data_ma$season == "2017/2018",]$season_week)),breaks=data_ma[data_ma$season == "2017/2018",]$season_week)+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
